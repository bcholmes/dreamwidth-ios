...
-(NSAttributedString*) userLabel:(NSString*) username icon:(UIImage*) icon font:(UIFont*) font {
    if (username == nil) {
        return [[NSAttributedString alloc] initWithString:@"(anonymous)" attributes:@{ NSFontAttributeName : font, NSForegroundColorAttributeName : [BCHDWTheme instance].primaryDarkColor}];
    } else {
        if (icon == nil) {
